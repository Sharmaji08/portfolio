...
const projects: Project[] = [
  {
    ...
    description: 'A comprehensive dashboard for managing online store operations with analytics and inventory tracking.',
  ...
  },
  {
    ...
    description: 'A mobile application for booking flights, hotels, and experiences with personalized recommendations.',
